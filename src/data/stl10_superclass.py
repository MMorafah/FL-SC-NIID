...
def STL10_SuperClass(train_ds, test_ds, args):
...
def STL10_SuperClass_NIID(train_ds, test_ds, nlabels, args):
...
def STL10_SuperClass_NIID_DIR(train_ds, test_ds, args):
...
def STL10_SuperClass_Old_NIID(train_ds, test_ds, nlabels, args):
    ...
    sc1 = np.random.choice(classes, size=3, replace=False).tolist()
...
def STL10_SuperClass_Old_NIID_DIR(train_ds, test_ds, args):
