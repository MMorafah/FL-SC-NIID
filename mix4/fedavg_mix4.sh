...
#SBATCH --gres=gpu:1
#SBATCH --job-name=fedavg_mix4_homo_5ep_123
#SBATCH --err=results/fedavg_mix4_homo_5ep_123.err
#SBATCH --out=results/fedavg_mix4_homo_5ep_123.out
...
do
    dir='../save_results/fedavg/homo/mix4'
    if [ ! -e $dir ]; then
    mkdir -p $dir 
    fi 
    
    python ./main_fedavg_mix4.py --trial=$trial \
    --rounds=50 \
    --num_users=100 \
    --frac=0.1 \
    --local_ep=5 \
