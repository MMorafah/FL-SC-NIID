...
#SBATCH --gres=gpu:1
#SBATCH --job-name=ifca_mix4_homo_2clusters_5ep_123
#SBATCH --err=results/ifca_mix4_homo_2clusters_5ep_123.err
#SBATCH --out=results/ifca_mix4_homo_2clusters_5ep_123.out
...
do
    ...
    do
        ...
        --gpu=0 \
        --print_freq=10 \
        2>&1 | tee $dir'/'$trial'_'$nclusters'clusters.txt'
